...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.list_terminal_cmdqueue.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.DoubleClicked|QtWidgets.QAbstractItemView.EditTrigger.EditKeyPressed)
        self.list_terminal_cmdqueue.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DragDrop)
        self.list_terminal_cmdqueue.setDefaultDropAction(QtCore.Qt.DropAction.MoveAction)
        self.list_terminal_cmdqueue.setAlternatingRowColors(False)
        self.list_terminal_cmdqueue.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ContiguousSelection)
        self.list_terminal_cmdqueue.setViewMode(QtWidgets.QListView.ViewMode.ListMode)
